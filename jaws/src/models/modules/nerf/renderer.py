...
class NeRFRenderer(nn.Module):
    ...
    def _cascading(self, cas: torch.Tensor, xyzs: torch.Tensor) -> torch.Tensor:
        ...
        if self.iter_density < 16:
            ...
            for xs, ys, zs in product(X, Y, Z):
                ...
                for cas in range(self.cascade):
                    sigmas = self._cascading(cas, xyzs)
                    # assign
        ...
        if staged:
            ...
            for b in range(B):
                ...
                while head < N:
                    ...
                    # floater_pack = [weights, z_vals, sample_dist]
