...
def update_config_dict(cfg, args_dict):
    cfg.defrost()
    cfg.merge_from_file(args_dict["cfg"])
    cfg.merge_from_list(args_dict["opts"])
    ...
    # if cfg.TEST.MODEL_FILE:
    # external model file
    cfg.TEST.MODEL_FILE = os.path.join(cfg.DATA_DIR, args_dict["model_file"])
